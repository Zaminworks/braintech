...
def generate_tags(topic):
    ...
    message = f"Generate 30 SEO hashtags related to the topic '{topic}' to improve SEO."
...
st.title("Hashtags Generator")

# Input box for the user to provide a topic
topic = st.text_input("Enter the topic for which you want SEO hashtags:")

# Button to trigger tags generation
if st.button("Generate Hashtags"):
    if topic:
        with st.spinner("Generating your SEO hashtags..."):
            tags_and_hashtags = generate_tags(topic)
            st.subheader("Generated SEO Hashtags")
